...
export default function Registration() {
  ...
  Alert.alert("Ошибка", "Что-то пошло не так при регистрации");
}
};
  ...
  return (
    <View style={[styles.container, {backgroundColor: bgColor}]}>
      ...
      <View>
        ...
        />
        <TouchableOpacity style={styles.eyePassword} onPress={() => setIsVisibleConfirm(prev => !prev)}>
          <AntDesign
            name={isVisibleConfirm ? "eye" : "eye-invisible"}
            size={24}
            color="white"
          />
        </TouchableOpacity>
      ...
      <TouchableOpacity style={[styles.loginScreenButton, 
        ...
        onPress={handleRegister} disabled={error ? true : false}>
        <Text style={styles.loginText}>Зарегестрироваться</Text>
      </TouchableOpacity>
      <View style={styles.viewForTxt}>
        <Text style={styles.txtForLogin}>Уже есть аккаунт?</Text>
      <TouchableOpacity 
        onPress={routerOnLogin}>
        <Text style={styles.txtForLoginBtn}>Войти</Text>
      </TouchableOpacity>
      </View>
      </View>
    </View>
