...
export default function Library() {
        ...
        <TouchableOpacity style={styles.trackItem} activeOpacity={0.7}>
            {item.artwork ? (
                ...
                <View style={[styles.trackImage, { backgroundColor: '#333', justifyContent: 'center', alignItems: 'center' }]}>
                    {/* <AntDesign name="playcircleo" size={20} color="#666" /> */}
                </View>
            )}
            ...
            <TouchableOpacity onPress={() => {/* Логика удаления из избранного */}}>
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.likedHeroCard}>
            ...
            {loading ? (
                ...
                <FlatList
                    ...
                    refreshControl={
                        <RefreshControl refreshing={false} onRefresh={fetchFavorites} tintColor="#fff" />
                    }
                    ListEmptyComponent={
...
const styles = StyleSheet.create({
    ...
    gradientPlaceholder: {
        ...
        height: 60,
        borderRadius: 8,
        backgroundColor: '#6b1fb3', // Фиолетовый градиент как в Spotify
